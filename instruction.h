 ...
 * for a raw array during initialization.
 *
...
/*
 * @brief Append a new value to the instructions array.
 * If the instructions array still has free space left, this function will
 * simply push the new value to it. Otherwise, it will allocate additional space
 * for the new value by copying the old array to a new one, growing it's size
 * and finally appending the new value to the just created array.
 *
